...
const Sidebar = ({ activePage, setPage, isOpen }: { activePage: Page, setPage: (p: Page) => void, isOpen: boolean }) => {
  const navItems = [
    ...
    { id: 'logs', label: 'Discrepancy Logs', icon: AlertCircle },
  ...
  return (
    <aside className={cn(
      ...
      <div className="p-6 border-b border-outline-variant/10">
        ...
        <p className="text-[10px] text-outline uppercase font-bold tracking-widest mt-1">Clinical Architect v1.0</p>
      </div>
      ...
      <div className="p-4 border-t border-outline-variant/10 space-y-1">
        <button className="w-full flex items-center gap-3 px-3 py-2 text-outline hover:text-tertiary text-xs font-medium transition-colors">
          <LogOut size={18} />
          Log Out
        </button>
      </div>
  ...
  return (
    <header className="h-16 fixed top-0 right-0 left-0 lg:left-64 bg-surface/80 backdrop-blur-md border-b border-outline-variant/30 flex items-center justify-between px-4 md:px-8 z-20">
      <div className="flex items-center gap-4 md:gap-8">
        ...
        <div className="hidden lg:flex items-center bg-surface-container rounded-lg px-3 py-1.5 group focus-within:ring-2 ring-primary/20 transition-all">
          <Search size={16} className="text-outline" />
          <input 
            type="text" 
            placeholder="Search Part Number..." 
            className="bg-transparent border-none focus:ring-0 text-sm w-64 placeholder:text-outline-variant"
          />
        </div>
      </div>

      <div className="flex items-center gap-2 md:gap-4">
        <button className="hidden sm:flex bg-primary text-on-primary px-3 md:px-4 py-2 rounded-lg font-medium text-xs md:text-sm items-center gap-2 hover:bg-primary-container transition-all shadow-sm active:scale-95">
          <Download size={18} />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
              <div>
                ...
                <p className="text-lg font-bold">SPR-0012</p>
              </div>
              <div>
                <p className="text-[11px] text-outline uppercase font-bold">Part Name</p>
                <p className="text-lg font-bold">Spur Gear 2.5g</p>
              </div>
              <div>
                <p className="text-[11px] text-outline uppercase font-bold">Vendor</p>
                <p className="text-lg font-bold">PT. Sejahtera</p>
              </div>
              <div>
                <p className="text-[11px] text-outline uppercase font-bold">Target Qty</p>
                <p className="text-lg font-bold text-primary">100 pcs</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-[11px] text-outline font-bold uppercase">Uptime</p>
              <p className="text-xl font-mono font-bold">02:45:12</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-sm border border-outline-variant/10 flex flex-col">
          <div className="p-6 flex justify-between items-center border-b border-outline-variant/10">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold text-outline uppercase">AI Confidence</span>
            ...
            <div className="absolute inset-0 p-8 flex flex-col justify-between">
              ...
              <div className="flex justify-center">
                <div className="bg-black/60 backdrop-blur-md px-6 py-3 rounded-xl border border-white/10 flex items-center gap-4">
                  ...
                  <span className="text-3xl font-mono font-bold text-white">99 pcs</span>
                </div>
              </div>
              <div className="flex justify-between">
        ...
        <div className="space-y-8">
          <div className="bg-surface-container-lowest p-8 rounded-2xl shadow-sm border border-outline-variant/10 relative overflow-hidden">
            ...
            <div className="flex items-baseline gap-4">
              <span className="text-6xl font-extrabold tracking-tighter font-mono">247.50</span>
            ...
            <div className="mt-6 flex items-center gap-3 p-4 bg-surface-container-low rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm font-bold">99 pcs <span className="text-[10px] font-normal text-outline-variant">(2.50g base)</span></p>
              </div>
            </div>
          </div>

          <div className="bg-tertiary p-8 rounded-2xl shadow-lg relative overflow-hidden text-on-primary">
            ...
            <div className="flex items-center justify-between relative z-10">
              <div>
                <p className="text-7xl font-black tracking-tighter">REJECT</p>
                <p className="text-sm font-bold mt-2 uppercase tracking-wide opacity-90">Discrepancy: -1 pcs</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-black opacity-20 tracking-widest leading-none mb-1">NG</div>
  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-8 bg-surface-container-lowest rounded-2xl p-6 md:p-8 shadow-sm border border-outline-variant/10 relative overflow-hidden">
        ...
        <div className="lg:col-span-4 bg-primary-container rounded-2xl p-6 md:p-8 text-white relative overflow-hidden flex flex-col justify-between shadow-lg">
          <div className="relative z-10">
            <h3 className="font-bold text-lg mb-1 tracking-tight">Batch Update</h3>
            <p className="text-xs opacity-90 leading-relaxed">System-wide tolerance update scheduled for UTC 14:00 today.</p>
          </div>
          <button className="mt-4 bg-white/20 hover:bg-white/30 text-white text-[10px] font-bold py-2 px-4 rounded-lg backdrop-blur-sm self-start transition-colors uppercase tracking-widest border border-white/20">
            View Schedule
          </button>
        </div>
      </div>
      ...
      <section className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3 bg-surface-container-low p-2 rounded-2xl">
          <div className="flex items-center bg-surface-container-lowest px-4 py-2 rounded-xl shadow-sm">
            ...
            <span className="text-sm font-medium">Apr 01 - Apr 15, 2026</span>
          </div>
          <select className="bg-surface-container-lowest border-none px-4 py-2 rounded-xl shadow-sm text-sm font-medium focus:ring-0">
            <option>All Statuses</option>
            <option selected>REJECT</option>
          </select>
          <button className="flex items-center gap-2 px-4 py-2 bg-on-surface text-white rounded-xl text-sm font-semibold hover:bg-on-surface/90 transition-all">
            <Download size={16} />
            Export
          </button>
        </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <div className="text-sm font-mono flex items-center gap-2">
                        ...
                        <span className={cn("font-bold", log.status === 'REJECTED' ? "text-tertiary" : "text-primary")}>{log.actual}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-5">
                      <span className={cn(
                        ...
                        log.status === 'REJECTED' ? "bg-tertiary text-white" : "bg-primary text-white"
                      )}>
        ...
        <aside className="w-full xl:w-96 flex flex-col gap-6 sticky top-24">
          <div className="glass-panel p-6 rounded-2xl border border-white shadow-xl">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="px-2 py-0.5 bg-tertiary text-[10px] font-black text-white rounded">CRITICAL</span>
            </div>
            <div className="w-full h-56 bg-surface-container-highest rounded-xl relative overflow-hidden mb-6">
              <img 
                src="https://picsum.photos/seed/heatmap/400/300" 
                alt="Heatmap" 
                className="w-full h-full object-cover"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-4">
                <span className="text-white text-[10px] font-bold uppercase tracking-widest">Heatmap Analysis</span>
                <span className="text-white/80 text-[10px]">Anomaly detected in Zone B-4</span>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex flex-col">
                <span className="text-[10px] text-outline font-bold uppercase tracking-widest">Log Detail</span>
                <span className="text-sm font-medium mt-1">Batch ID: IQC-B-9981-A</span>
              </div>
              <div className="grid grid-cols-3 gap-2 py-4 border-y border-outline-variant/10">
                ...
                <div className="flex flex-col items-center border-x border-outline-variant/10">
                  ...
                  <span className="text-lg font-bold text-tertiary">{selectedLog.actual}</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="text-[10px] text-outline font-medium">Variance</span>
                  <span className="text-lg font-bold text-tertiary">{selectedLog.actual - selectedLog.target} pcs</span>
                </div>
              </div>
              <div className="bg-tertiary/10 p-4 rounded-xl flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-tertiary/80 mt-1 leading-relaxed">Visual inspection confirmed {selectedLog.aiCount} units. Digital scale sensor reported {selectedLog.sensorWeight}, indicating discrepancy.</p>
                </div>
              </div>
...
export default function App() {
  const isPage = (value: string | null): value is Page => {
    return value === 'live' || value === 'master' || value === 'logs';
  };

  const [currentPage, setCurrentPage] = useState<Page>(() => {
    const storedPage = localStorage.getItem('dashboard_page');
    return isPage(storedPage) ? storedPage : 'live';
  });
  ...
  const loadData = async () => {
    try {
      ...
      if (!dbParts || dbParts.length === 0) {
         // Fallback: Populate DB from Mock Data
         for (const mock of MOCK_PARTS) {
            let vendor_id = '';
            const { data: vData } = await supabase.from('vendors').insert({ name: mock.vendor, code: 'V-' + Math.random().toString().slice(2,8) }).select('id').single();
            if(vData) vendor_id = vData.id;

            await supabase.from('parts').insert({
              code: mock.code,
              name: mock.name,
              weight_target_gram: parseFloat(mock.unitWeight),
              weight_tolerance_gram: parseFloat(mock.tolerance.replace(/[^\d.]/g, '') || '0.5'),
              vendor_id,
              target_qty: mock.target,
              actual_qty: mock.actual
            });
         }
         
         for (const mockLog of MOCK_LOGS) {
            await supabase.from('verification_logs').insert({
               id: mockLog.id,
               timestamp: new Date(mockLog.timestamp.replace(' ', 'T')).toISOString(),
               part_code: mockLog.code,
               target_qty: mockLog.target,
               ai_count: mockLog.aiCount,
               load_cell_count: parseFloat(mockLog.sensorWeight.replace('g', '')),
               final_count: mockLog.actual,
               diff_pct: mockLog.actual - mockLog.target,
               status: mockLog.status
            });
         }
         
         return loadData(); // Reload safely
      } else {
      ...
      if (dbLogs) {
        const formattedLogs: LogEntry[] = dbLogs.map((l: any) => {
           ...
           if (!isNaN(rawDate.getTime())) {
             const gmt7Date = new Date(rawDate.getTime() + 7 * 60 * 60 * 1000);
             tsStr = gmt7Date.toISOString().replace('T', ' ').substring(0, 19);
           }
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      default: return <LiveInspection logs={logs} setPage={setCurrentPage} />;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-surface flex">
      ...
      <div className={cn(
        ...
        <footer className="p-4 md:p-8 border-t border-outline-variant/10 flex flex-col md:flex-row justify-between gap-6 text-outline text-[11px] font-medium tracking-wide">
